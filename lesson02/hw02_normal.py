...
day = {
    ...
    '19': 'девятнадцатое', '20': 'двацатое', '21': 'двадцать первое', '22': 'двадцать втрое', '23': 'двадцать треть',
...
print('{} {} {} года'.format(str(day.get(date_list[0])).title(), month.get(date_list[1]), date_list[2]))
